              ...
              {loading ? (
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-right font-black text-slate-900">$ {totalDebe.toLocaleString(undefined, { minimumFractionDigits: 2 })}</td>
                    <td className="px-6 py-4 text-sm text-right font-black text-slate-900">$ {totalHaber.toLocaleString(undefined, { minimumFractionDigits: 2 })}</td>
                    <td className="px-6 py-4">
